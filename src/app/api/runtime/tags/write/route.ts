 ...
 * только целым сохранённым рецептом либо изнутри серверного Java-скрипта, где оно
 * зашито в код. Оператору нужно произвольное значение, поэтому запрос отдельный.
 *
 * Рецепты сюда не ходят: с 09.09.2026 рецепт — процедура из шагов, и теги внутри шага
 * пишет сам рантайм (`ProcedureExecutionService`), а не фронт.
 *
